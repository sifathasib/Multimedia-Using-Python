...
class MyForm(QDialog):
    def __init__(self):
        ...
        self.ui.radioButtonCash.toggled.connect(self.dispSelected)
        self.show()
    def dispSelected(self):
        ...
        if self.ui.radioButtonCash.isChecked() == True:
            selected2 = 'Cash'
        self.ui.labelSelected.setText('chosen shirt size is '+ selected + ' and payment system is '+ selected2)
